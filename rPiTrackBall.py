...
if __name__ == "__main__":
    ...
    yellowLower = (15, 125, 0)   # (h, s, v)
    yellowUpper = (47, 200, 255)
    ...
    while True:
        ...
        if frameTime == 0:
            ...
            for c in cnts:
                ...
                # centroid
                # radius = 0 # Does it help to clear this?
                ...
                if radius > 10:
                    ...
                    circleColor = (0, 255, 255)  # TODO verify, I think it is B, G, R
                    thickness = 2
                    cv2.circle(img, (int(x), int(y)), int(radius),
                               circleColor, thickness)
